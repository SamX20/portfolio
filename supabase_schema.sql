...
insert into sections (id, section, key, value) values
  ...
  ('hero-video_url_alt', 'hero', 'video_url_alt', ''),
  ('hero-theme_accent', 'hero', 'theme_accent', '#8ed8ff'),
  ('hero-theme_accent_mid', 'hero', 'theme_accent_mid', '#4aa3ff'),
  ('hero-theme_accent_deep', 'hero', 'theme_accent_deep', '#2563eb'),
  ('hero-theme_alt_accent', 'hero', 'theme_alt_accent', '#ff9a57'),
  ('hero-theme_alt_accent_mid', 'hero', 'theme_alt_accent_mid', '#e5682f'),
  ('hero-theme_alt_accent_deep', 'hero', 'theme_alt_accent_deep', '#405044'),
