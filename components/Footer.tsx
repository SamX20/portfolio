...
export default function Footer({ sections, socialLinks = [] }: FooterProps) {
  ...
  return (
    <footer style={{ backgroundColor: '#080810', borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <motion.div
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10 text-right">
          ...
          {/* Quick Links */}
          <motion.div variants={itemVariants}>
            <h4 className="text-white font-bold mb-4 text-sm tracking-wide">الروابط السريعة</h4>
